...
function Start() {
  ...
  SYSMIRROR2='http://os.815494.xyz/centos/CentOS_7.X_NetInstallation_Final.vhd.gz'
  ...
  SYSMIRROR13='http://os.815494.xyz/os/windows/2016/winsrv2016-data-x64-cn.vhd.gz'
  ...
  if [[ "$isCN" == '1' ]];then
    sed -i 's#http://os.815494.xyz/os/reinstall/wget_udeb_amd64.tar.gz#http://raw.githubusercontent.com/fcurrk/reinstall/master/wget_udeb_amd64.tar.gz#' /tmp/Core_Install.sh
  ...
  case $N in
    ...
    4) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -c 6.10 -v 64 -a -p 815494.com $NETSTR $CMIRROR ;;
    5) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -d 11 -v 64 -a -p 815494.com $NETSTR $DMIRROR ;;
    6) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -d 10 -v 64 -a -p 815494.com $NETSTR $DMIRROR ;;
    7) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -d 9 -v 64 -a -p 815494.com $NETSTR $DMIRROR ;;
    8) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -d 8 -v 64 -a -p 815494.com $NETSTR $DMIRROR ;;
    9) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -u 20.04 -v 64 -a -p 815494.com $NETSTR $UMIRROR ;;
    10) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -u 18.04 -v 64 -a -p 815494.com $NETSTR $UMIRROR ;;
    11) echo -e "\nPassword: 815494.com\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/Core_Install.sh -u 16.04 -v 64 -a -p 815494.com $NETSTR $UMIRROR ;;
